...
layout=go.Layout(title = 'Solar System', showlegend=False, margin=dict(l=0, r=0, t=0, b=0),
                  ...
                  scene = dict(xaxis=dict(title='Distance from the Sun', 
                               ...
                               annotations=[
                                   annot(distance_from_sun[0], 40, 'Солнце', xancr='left'),
                                   annot(distance_from_sun[1], 5, 'Меркурий'),
                                   annot(distance_from_sun[2], 9, 'Венера'),
                                   annot(distance_from_sun[3], 9, 'Земля'),
                                   annot(distance_from_sun[4], 7, 'Марс'),
                                   annot(distance_from_sun[5], 30, 'Юпитер'),
                                   annot(distance_from_sun[6], 28, 'Сатурн'),
                                   annot(distance_from_sun[7], 20, 'Уран'),
                                   annot(distance_from_sun[8], 20, 'Нептун'),
                                   ]
                               ))
